    ...
    <div class="page-header-content d-lg-flex">
        <div class="d-flex">
            <h4 class="page-title mb-0">
                Home - <span class="fw-normal">Jemaat Lahir</span>
            </h4>
            <a href="#page_header"
    ...
    <div class="page-header-content d-lg-flex border-top">
        <div class="d-flex">
            <div class="breadcrumb py-2">
                ...
                <span class="breadcrumb-item active">Jemaat Lahir</span>
            </div>
...
<div class="content">
    <div class="card">
        <div class="card-header d-flex">
            <h5 class="mb-0">Daftar Jemaat Lahir</h5>
            <div class="ms-auto">
                <a class="btn btn-primary" href="{{ route('JemaatLahir.create') }}"><i
                        class="ph-plus-circle"></i><span class="d-none d-lg-inline-block ms-2">Tambah Jemaat Lahir</span></a>
            </div>
        </div>
