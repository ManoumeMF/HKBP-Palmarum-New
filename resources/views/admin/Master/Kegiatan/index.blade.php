    ...
    <div class="page-header-content d-lg-flex">
        <div class="d-flex">
            <h4 class="page-title mb-0">
                Home - <span class="fw-normal">Kegiatan</span>
            </h4>
            <a href="#page_header"
...
<div class="content">
    <div class="card">
        <div class="card-header d-flex">
            ...
            <div class="ms-auto">
                <a class="btn btn-primary" href="{{ route('Kegiatan.create') }}"><i
                        class="ph-plus-circle"></i><span class="d-none d-lg-inline-block ms-2">Tambah Kegiatan
                        Baru</span></a>
            </div>
        </div>
