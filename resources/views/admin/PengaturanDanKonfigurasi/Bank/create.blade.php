                ...
                <div class="col-lg-9 offset-lg-1">
                    <form action="{{ route('Bank.store') }}" method="post" class="needs-validation" novalidate>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control" placeholder="Masukkan Nama Pemilik" required name="nama_pemilik">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control" placeholder="Masukkan Nomor Rekening" required name="nomor_rekening">
