...
$(document).on('click', '.detailBtn', function(e) {
    ...
    $.ajax({
        method: "GET",
        url: "{{ route('Bank.detail') }}", // Ensure this route is defined in your web.php
        data: {
            id: fe_id
        },
        success: function(response) {
            if (response.status == 404) {
                ...
                $('#detail_nama_bank').text(response.bank.nama_bank);
                $('#detail_keterangan').text(response.bank.keterangan);
                $('#detail_nama_gereja').text(response.bank.nama_gereja);
                $('#detail_nama_pemilik').text(response.bank.nama_pemilik);
                $('#detail_nomor_rekening').text(response.bank.nomor_rekening);
            }
        }
    });
});
...
<div class="content">
    <div class="card">
        <div class="card-header d-flex">
            ...
            <div class="ms-auto">
                <a class="btn btn-primary" href="{{ route('Bank.create') }}"><i
                        ...
                        <div class="d-inline-flex">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    <button type="button" value="{{ $r -> id_bank_gereja }}"
                                        class="dropdown-item text-info detailBtn">
                                        <i class="ph-list me-2"></i>Detail
                                    </button>
                                    <button type="button" value="{{ $r -> id_bank_gereja }}"
                                        class="dropdown-item text-secondary">
                                        <a href="{{ route('Bank.edit', $r -> id_bank_gereja) }}"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container">
                    ...
                    <div class="row mb-2">
                        <label for="detail_nama_bank" class="col-lg-4 col-form-label">Nama Bank:</label>
                        <div class="col-lg-7">
                            <label id="detail_nama_bank" class="col-form-label"></label>
                        </div>
                    </div>
                    <div class="row mb-2">
                        <label for="detail_nama_pemilik" class="col-lg-4 col-form-label">Nama Pemilik:</label>
                        <div class="col-lg-7">
                            <label id="detail_nama_pemilik" class="col-form-label"></label>
                        </div>
                    </div>
                    <div class="row mb-2">
                        <label for="detail_nomor_rekening" class="col-lg-4 col-form-label">Nomor Rekening:</label>
                        <div class="col-lg-7">
                            <label id="detail_nomor_rekening" class="col-form-label"></label>
                        </div>
                    </div>
                    <div class="row mb-2">
