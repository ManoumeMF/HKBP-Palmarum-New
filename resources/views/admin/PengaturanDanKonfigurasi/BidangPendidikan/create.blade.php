    ...
    <div class="page-header-content d-lg-flex">
        <div class="d-flex">
            <h4 class="page-title mb-0">
                Pengaturan dan Konfigurasi - <span class="fw-normal">Bidang Pendidikan</span>
            </h4>
            <a href="#page_header"
    ...
    <div class="page-header-content d-lg-flex border-top">
        <div class="d-flex">
            ...
            <a href="{{ route('Dashboard.index') }}" class="breadcrumb-item"><i class="ph-house"></i></a>
                    ...
                    <a href="{{ route('BidangPendidikan.index') }}" class="breadcrumb-item active">Bidang Pendidikan</a>
                </div>
