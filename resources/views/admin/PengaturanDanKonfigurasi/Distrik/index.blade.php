    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.status == 404) {
                ...
                $('#detail_nama_distrik').text(response.distrik.nama_distrik);
                $('#detail_subdis_name').text(response.distrik.subdis_name);
...
<div class="content">
    <div class="card">
        <div class="card-header d-flex">
            <h5 class="mb-0">Daftar Distrik</h5>
            <div class="ms-auto">
                <a class="btn btn-primary" href="{{ route('Distrik.create') }}"><i
        ...
        <table id="bidangPendidikanTable" class="table datatable-basic table-striped">
            ...
            <tbody>
                @if (isset($distrik) && count($distrik) > 0)
                @foreach ($distrik as $r)
                <tr>
                            <td>{{ $r->kode_distrik }}</td>
                            <td>{{ $r->nama_distrik }}</td>
                            <td>{{ $r->alamat }}</td>
                            <td>{{ $r->subdis_name }}</td>
                        ...
                        <div class="d-inline-flex">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    <button type="button" value="{{ $r -> id_distrik }}"
                                        class="dropdown-item text-info detailBtn">
                                        <i class="ph-list me-2"></i>Detail
                                    </button>
                                    <button type="button" value="{{ $r -> id_distrik }}"
                                        class="dropdown-item text-secondary">
                                        <a href="{{ route('Ressort.edit', $r -> id_distrik) }}"
                ...
                <div class="container">
                    <div class="row mb-2">
                        <label for="detail_nama_ressort" class="col-lg-4 col-form-label">
                            Kode Distrik:</label>
                        <div class="col-lg-7">
                            <label id="detail_kode_distrik" class="col-form-label"></label>
                        </div>
                    </div>
                    <div class="row mb-2">
                        <label for="detail_alamat" class="col-lg-4 col-form-label">Nama Distrik:</label>
                        <div class="col-lg-7">
                            <label id="detail_nama_distrik" class="col-form-label"></label>
                        </div>
                    </div>
                    <div class="row mb-2">
                    ...
                    <div class="row mb-2">
                        <label for="detail_pendeta_ressort" class="col-lg-4 col-form-label">Alamat:</label>
                        <div class="col-lg-7">
...
<div id="deleteModal" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Hapus Data Distrik</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
