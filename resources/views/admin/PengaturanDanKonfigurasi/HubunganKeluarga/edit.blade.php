...
<div class="content">
    ...
    <div class="card" style="height:100%;">
        <div class="card-header">
            <h5 class="mb-0">Edit Hubungan Keluarga</h5>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-lg-9 offset-lg-1">
                    ...
                    <form action="{{ route('Hubungan-Keluarga.update', $fieldHubunganKeluarga -> id_hub_keluarga)}}"
                        ...
                        @csrf
                        <div class="row mb-3">
                            <label class="col-lg-3 col-form-label">Hubungan Keluarga<span
                                    class="text-danger">*</span></label>
                            <div class="col-lg-9">
                                <input type="text" class="form-control" placeholder="Masukkan Hubungan Keluarga"
                                    required value="{{ $fieldHubunganKeluarga -> nama_hub_keluarga }}"
                                    name="hubunganKeluarga">
                                <div class="invalid-feedback">Hubungan Keluarga Tidak Boleh Kosong.</div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <textarea rows="3" cols="3" class="form-control" placeholder="Masukkan Keterangan"
                                    name="keterangan">{{ $fieldHubunganKeluarga -> keterangan }}</textarea>
                            </div>
                        </div>
                        <div class="text-end">
