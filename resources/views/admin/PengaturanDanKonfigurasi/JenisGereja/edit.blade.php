...
<div class="content">
    ...
    <div class="card" style="height:100%;">
        <div class="card-header">
            <h5 class="mb-0">Ubah Jenis Gereja</h5>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-lg-9 offset-lg-1">
                @if (isset($jenisGereja))
                    <form action="{{ route('JenisGereja.update', $jenisGereja -> id_jenis_gereja)}}" method="post" class="needs-validation" novalidate>
                        {{ csrf_field() }}
                        <div class="row mb-3">
                            <label class="col-lg-3 col-form-label">Jenis Gereja<span class="text-danger">
                                    *</span></label>
                            <div class="col-lg-9">
                                <input type="text" class="form-control" placeholder="Masukkan Jenis Gereja" required
                                    name="JenisGereja" value="{{ $jenisGereja -> jenis_gereja }}">
                                <div class="invalid-feedback">Jenis Gereja Tidak Boleh Kosong.</div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <textarea rows="3" cols="3" class="form-control" placeholder="Masukkan Keterangan"
                                    name="Keterangan">{{ $jenisGereja -> keterangan }}</textarea>
                            </div>
                        </div>
                        <div class="text-end">
                            <a href="">
                            ...
                            <a href="{{ route('JenisGereja.index') }}">
