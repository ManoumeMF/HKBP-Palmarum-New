...
<div class="content">
    ...
    <div class="card" style="height:100%;">
        <div class="card-header">
            <h5 class="mb-0">Tambah Jenis Registrasi</h5>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-lg-9 offset-lg-1">
                    <form action="{{route('JenisRegistrasi.store')}}" method="post" class="needs-validation" novalidate>
                        {{ csrf_field() }}
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control" placeholder="Masukkan Nama Jenis Registrasi"
                                    required name="nama_jenis_registrasi">
                                <div class="invalid-feedback">Nama Jenis Registrasi Tidak Boleh Kosong.</div>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-lg-3 col-form-label">Nama Sub Jenis Registrasi<span class="text-danger">*</span></label>
                            <div class="col-lg-9">
                                <input type="text" class="form-control" placeholder="Masukkan Sub Jenis Registrasi"
                                    required name="sub_jenis_registrasi">
                                <div class="invalid-feedback">Nama sub Jenis Registrasi Tidak Boleh Kosong.</div>
                            </div>
                        </div>
                        <div class="row mb-3">
