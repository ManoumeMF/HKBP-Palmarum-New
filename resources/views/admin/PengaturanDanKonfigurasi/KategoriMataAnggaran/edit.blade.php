...
<div class="content">
    ...
    <div class="card" style="height:100%;">
        <div class="card-header">
            <h5 class="mb-0">Ubah Kategori Mata Anggaran</h5>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-lg-9 offset-lg-1">
                @if (isset($kategoriMataAnggaran))
                    <form action="{{ route('KategoriMataAnggaran.update', $kategoriMataAnggaran -> id_kategori_anggaran)}}" method="post" class="needs-validation" novalidate>
                        {{ csrf_field() }}
                        <div class="row mb-3">
                            <label class="col-lg-3 col-form-label">Induk Kategori Anggaran</label>
                            <div class="col-lg-9">
                                <input type="number" class="form-control" placeholder="Masukkan Induk Kategori Anggaran" 
                                value="{{ $kategoriMataAnggaran -> induk_kategori_anggaran }}" name="IndukKategoriAnggaran">
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control" placeholder="Masukkan Kode Kategori Anggaran" required 
                                value="{{ $kategoriMataAnggaran -> kode_kategori_anggaran }}" name="KodeKategoriAnggaran">
                        ...
                        <div class="row mb-3">
                            <label class="col-lg-3 col-form-label">Nama Kategori Anggaran
                                <span class="text-danger">*</span></label>
                            <div class="col-lg-9">
                                <input type="text" class="form-control" placeholder="Masukkan Nama Kategori Anggaran" required 
                                value="{{ $kategoriMataAnggaran -> nama_kategori_Anggaran }}" name="NamaKategoriAnggaran">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                ...
                                name="Keterangan">{{ $kategoriMataAnggaran -> keterangan }}</textarea>
                            </div>
                        </div>
                        <div class="text-end">
                            <a href="">
