        ...
        <div class="page-header-content d-lg-flex">
            <div class="d-flex">
                <h4 class="page-title mb-0">
                    Pengaturan dan Konfigurasi - <span class="fw-normal">Dashboard</span>
                </h4>
                <a href="#page_header"
                ...
                <div class="row">
                    <div class="col-lg-9 offset-lg-1">
                        @if (isset($fieldPendidikan))
                            <form action="{{ route('Pendidikan.update', $fieldPendidikan->id_pendidikan)}}" method="post"
                                class="needs-validation" novalidate>
                                @csrf
                                <div class="row mb-3">
                                    <label class="col-lg-3 col-form-label">Pendidikan<span class="text-danger">*</span></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" placeholder="Masukkan Pendidikan" required
                                            value="{{ $fieldPendidikan->pendidikan }}" name="pendidikan">
