    ...
    <div class="page-header-content d-lg-flex border-top">
        <div class="d-flex">
            <div class="breadcrumb py-2">
                ...
                <a href="{{ route('Sentralisasi.index') }}" class="breadcrumb-item active">Jenis Gereja</a>
            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <textarea rows="3" cols="3" class="form-control" placeholder="Masukkan Keterangan"
                                    name="Keterangan">{{ $sentralisasi -> keterangan }}</textarea>
                            </div>
                        </div>
                        <div class="text-end">
                            <a href="">
                            ...
                            <a href="{{ route('Sentralisasi.index') }}">
