    ...
    <div class="card" style="height:100%;">
        ...
        <div class="card-body">
            <div class="row">
                ...
                @if (isset($status))
                    <form action="{{ route('Status.update', $status -> id_status)}}" method="post" class="needs-validation" novalidate>
                        {{ csrf_field() }}
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control" placeholder="Masukkan Status" required
                                    name="namaStatus" value="{{ $status -> status }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <textarea rows="3" cols="3" class="form-control" placeholder="Masukkan Keterangan"
                                    name="keterangan">{{ $status -> keterangan }}</textarea>
                            </div>
                        </div>
                        <div class="text-end">
