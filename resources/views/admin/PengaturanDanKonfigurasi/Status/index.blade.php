...
<div class="content">
    <div class="card">
        <div class="card-header d-flex">
            ...
            <div class="ms-auto">
            <a class="btn btn-primary" href="{{ route('Status.create') }}"><i
                        ...
                        <div class="d-inline-flex">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    <button type="button" value="{{ $st -> id_status }}"
                                        class="dropdown-item text-info detailBtn">
                                        <i class="ph-list me-2"></i>Detail
                                    </button>
                                    <button type="button" value="{{ $st -> id_status }}"
                                        class="dropdown-item text-secondary">
                                        <a href="{{ route('Status.edit', $st -> id_status) }}"
                    ...
                    <div class="container">
                        ...
                        <div class="row mb-2">
                            <label for="detail_jenis_status" class="col-lg-4 col-form-label">
                                Nama Status:</label>
                            <div class="col-lg-7">
                                <label id="detail_status" class="col-form-label"></label>
                            </div>
                        </div>
                        <div class="row mb-2">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="deleteJenisStatusForm">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-primary delete_status">Hapus</button>
                    </div>
                </form>
            </div>
        </div>
