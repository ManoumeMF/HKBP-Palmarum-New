        ...
        <div class="container-fluid">
            ...
            <div class="navbar-brand flex-1 flex-lg-0">
                <a href="index.html" class="d-inline-flex align-items-center">
                    <img src="{{ asset('admin_resources/assets/images/icons/Logo_ITDEL transparent 1.png') }}" alt="">
                </a>
            </div>
                        ...
                        <div class="row row-cols-1 row-cols-sm-2 g-0">
                            <div class="col">
                                <button type="button"
                                    ...
                                    <div>
                                        <img src="{{ asset('admin_resources/assets/images/demo/logos/1.svg') }}"
                            ...
                            <div class="col">
                                <button type="button"
                                    ...
                                    <div>
                                        <img src="{{ asset('admin_resources/assets/images/demo/logos/2.svg') }}"
                                            class="h-40px mb-2" alt="">
                            ...
                            <div class="col">
                                <button type="button"
                                    ...
                                    <div>
                                        <img src="{{ asset('admin_resources/assets/images/demo/logos/3.svg') }}"
                                            class="h-40px mb-2" alt="">
                            ...
                            <div class="col">
                                <button type="button"
                                    ...
                                    <div>
                                        <img src="{{ asset('admin_resources/assets/images/demo/logos/4.svg') }}"
                                            class="h-40px mb-2" alt="">
                ...
                <div class="sidebar-section">
                    <ul class="nav nav-sidebar" data-nav-type="accordion">
                        ...
                        <li class="nav-item nav-item-submenu">
                            ...
                            <ul class="nav-group-sub collapse">
                                ...
                                <li class="nav-item nav-item-submenu">
                                    ...
                                    <ul class="nav-group-sub collapse">
                                        <li class="nav-item"><a href="" class="nav-link">Jenis Gereja</a></li>
                                        <li class="nav-item nav-item-submenu">
                                        </li>
                                ...
                                <li class="nav-item nav-item-submenu">
                                    ...
                                    <ul class="nav-group-sub collapse">
                                        <li class="nav-item"><a href="" class="nav-link">Kategori Mata Anggaran</a></li>
                                        <li class="nav-item"><a href="" class="nav-link">Mata Anggaran</a></li>
                                        <li class="nav-item"><a href="" class="nav-link">Set Sentralisasi</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item nav-item-submenu">
                            ...
                            <ul class="nav-group-sub collapse">
                                <li class="nav-item"><a href="" class="nav-link">Waktu Kegiatan</a></li>
                                <li class="nav-item"><a href="" class="nav-link">Jadwal Ibadah</a></li>
                            </ul>
                        </li>
                        <li class="nav-item nav-item-submenu">
                            <a href="#" class="nav-link">
                            ...
                            <ul class="nav-group-sub collapse">
                                <li class="nav-item"><a href="" class="nav-link">Jemaat Baru</a></li>
                                <li class="nav-item"><a href="" class="nav-link">Jemaat Pindah</a></li>
                                <li class="nav-item"><a href="" class="nav-link">Jemaat Lahir</a></li>
                                <li class="nav-item"><a href="" class="nav-link">Jemaat Meninggal</a></li>
                                <li class="nav-item"><a href="" class="nav-link">RPP</a></li>
                                <li class="nav-item"><a href="" class="nav-link">Pendaftaran Baptis</a></li>
                                <li class="nav-item"><a href="" class="nav-link">Pendaftaran Sidi</a></li>
                                <li class="nav-item"><a href="" class="nav-link">Pendaftaran Pernikahan</a></li>
                            </ul>
                        </li>
                        <li class="nav-item nav-item-submenu">
                            <a href="#" class="nav-link">
                            ...
                            <ul class="nav-group-sub collapse">
                                <li class="nav-item"><a href="" class="nav-link">Persembahan</a></li>
                                <li class="nav-item"><a href="" class="nav-link">Ucapan Syukur</a></li>
                                <li class="nav-item"><a href="" class="nav-link">Pembangunan</a></li>
                                <li class="nav-item"><a href="" class="nav-link">Iuran Bulanan</a></li>
                                <li class="nav-item"><a href="" class="nav-link">Lain-lain</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="flex-fill">
                        ...
                        <div class="bg-light rounded p-2 my-2">
                            <div class="d-flex align-items-center">
                                <div class="me-2">
                                    <img src="{{ asset('admin_resources/assets/images/icons/pdf.svg') }}" width="34"
                                        height="34" alt="">
                                </div>
                                <div class="flex-fill">
                                    new_contract.pdf
